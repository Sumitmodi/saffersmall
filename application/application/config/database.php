...
$db['default']['username'] = 'janpret_root';
$db['default']['password'] = 'Xp@F(hJn13p~rI$T#~';
$db['default']['database'] = 'janpret_saffersmall';
...
$db['custom']['password'] = '';
$db['custom']['database'] = '';
$db['custom']['dbdriver'] = 'mysqli';
$db['custom']['dbprefix'] = '';
$db['custom']['pconnect'] = TRUE;
$db['custom']['db_debug'] = FALSE;
