        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-4">
                    <p>Your one stop shopping mall.</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="logo-wrap" data-animate-to="fadeInLeft"><a href="<?php echo base_url(); ?>"> <img src="<?php echo base_url(); ?>assets/img/logo_main.png"></a>  </div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 clearfix">
                                    ...
                                    <form role="form" method="get" action="<?php echo base_url(); ?>search">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-5">
                                                <div class="form-group">
                                                    <input type="range" max="4000" min="50">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2">
                                                <div class="form-group">
                    ...
                    <div class="top-form pull-right" data-animate-to="fadeInRight">
                        <form role="form" class="form-inline" action="<?php echo base_url();?>search" method="get">
                            ...
                            <div class="form-group">
                                <input name="query" type="text" class="form-control" placeholder="Search ads here" id="autocomplete" >
