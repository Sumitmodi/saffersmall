...
<section class="create_account">
    <div class="<?php echo $this->input->is_ajax_request() ? '' : 'container'; ?>">
        ...
        <form action="<?php echo base_url(); ?>dashboard/accounts/change?target=email" method="post" class="form-horizontal">
            ...
            <?php } ?>
            <div class="form-group">
                <strong>Note:- Please make sure you get this email verified before you login next time.</strong>
            </div>
            <div class="form-group">
