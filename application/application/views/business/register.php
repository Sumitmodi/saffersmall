...
<section class="create_account">
    <div class="container">
        <h2>Create a Saffers mall account</h2>
        ...
        <form action="?type=business" method="post" class="form-horizontal">
            ...
            <div class="form-group" style='display:none' id='profile'>
                ...
                <div class="col-lg-7 col-md-7">
                    <input type="text" class="form-control" id="sfi_profile" name="sfi_profile[]" placeholder="Enter Profile Link" disabled="disabled"/>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-lg-offset-5 col-md-7 col-md-offset-5 col-sm-offset-4 col-sm-8">
                    <label class="control-label checkbox-ctrl">
                        ...
                        I have read the <a href='<?php echo base_url();?>terms'>Terms & Conditions</a> and agree to follow the <a href="<?php echo base_url();?>privacy">privacy policy</a>.
                    </label>
                </div>
            </div>
            <div class="form-group">
