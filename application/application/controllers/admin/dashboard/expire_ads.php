...
class Expire_ads extends CI_Controller
{
    ...
    public function expire_ads()
    {
        try
        {
            $ads = $this->model1->select('business_ads', '*', array('LOWER(status)' => 'e'));
            ...
            $this->header = 200;
             ...
             $this->message = $ads == false ? 'No expired ads currently' : count($ads) . ' ads have expired.';
