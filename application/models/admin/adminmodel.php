...
class AdminModel extends CI_Model {
    ...
    public function active_ads($id){
        ...
        $admin = $this->model->select('app_admin', 'username, sno, name', array('username'=>$this->session->userdata('admin_username')), NULL, 1);
        ...
        if($result){
            $activity = array(
                'aid' => $admin->sno,
                'activity' => "The &quot;{$ads->name}&quot; has been approved by &quot;{$admin->username}&quot;."
            );
                
            $notification = array(
                'ad_id'=>$id,
                'action'=>"The &quot;{$ads->name}&quot; has been approved by &quot;{$admin->username}&quot;.",
                        'notify'=>0
            );
    ...
    public function inactive_ads($id){
        ...
        if($result){
            $activity = array(
                'aid' => $admin->sno,
                'activity' => "The &quot;{$ads->name}&quot; has been inactivated by &quot;{$admin->username}&quot;."
            );
     ...
     public function disapprove_ads($id){
        ...
        if($result){
                $activity = array(
                'aid' => $admin->sno,
                'activity' => "The &quot;{$ads->name}&quot; has been disapproved by &quot;{$admin->username}&quot;."
            );
    ...
    public function active_user($id){
        $user = $this->model->select('app_users', 'username', array('sno'=>$id), NULL, 1);
        $admin = $this->model->select('app_admin', 'username, sno, name', array('username'=>$this->session->userdata('admin_username')), NULL, 1);
        ...
        if($result){
            $activity = array(
                'aid' => $admin->sno,
                'activity' => "The &quot;{$user->username}&quot; has been activated by &quot;{$admin->username}&quot;."
            );
    ...
    public function block_user($id){
        ...
        if($result){
            $activity = array(
                'aid' => $admin->sno,
                'activity' => "The &quot;{$user->username}&quot; has been blocked by &quot;{$admin->username}&quot;."
            );
    ...
    public function inactive_user($id){
        ...
        if($result){
            $activity = array(
                'aid' => $admin->sno,
                'activity' => "The &quot;{$user->username}&quot; has been inactivated by &quot;{$admin->username}&quot;."
            );
    ...
    public function active_business($id){
        $user = $this->model->select('business_members', 'business_name, username, person_name', array('sno'=>$id), NULL, 1);
        $admin = $this->model->select('app_admin', 'username,sno, name', array('username'=>$this->session->userdata('admin_username')), NULL, 1);
