...
<body>
    <header class="header">
        <div class="container-fluid clearfix">
            <div class="logo">
                <h1> <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/img/saffersmall-logo-final.png" alt="capital log" style="height: 85px"></a> </h1>
            </div>
            <div class="profile"> 
                <?php
                    ...
                    if ($username != NULL)
                    {
                        ...
                        <div class="left-nav collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="<?php echo base_url(); ?>admin/admin_blog"><span><i class="glyphicon glyphicon-edit"></i></span><strong>Blog</strong></a>
                                    <ul>
                                        <li><a href="<?php echo base_url(); ?>admin/admin_blog"><i class="fa fa-caret-right"></i>Blog List</a></li>
                                        <li><a href="<?php echo base_url(); ?>admin/admin_blog?target=add"><i class="fa fa-caret-right"></i>Add Blog</a></li>
                                    </ul>
                                </li>
                                
                                <li><a href="<?php echo base_url(); ?>admin/admin_social_links"><span><i class="glyphicon glyphicon-edit"></i></span><strong>Links Settings</strong></a>
                                    <ul>
                                        <li><a href="<?php echo base_url(); ?>admin/admin_social_links"><i class="fa fa-caret-right"></i>Social Link List</a></li>
                                        <li><a href="<?php echo base_url(); ?>admin/admin_social_links?target=add"><i class="fa fa-caret-right"></i>Add Social Link</a></li>
                                        <li><a href="<?php echo base_url(); ?>admin/invitation_gateway_links"><i class="fa fa-caret-right"></i>Invitation Gateway Link</a></li>
                                        <li><a href="<?php echo base_url(); ?>admin/invitation_gateway_links?target=add"><i class="fa fa-caret-right"></i>Add Gateway Link</a></li>
                                       
                                    </ul>
                                </li>
                                
                                <li><a href="<?php echo base_url(); ?>admin/admin_logos"><span><i class="glyphicon glyphicon-edit"></i></span><strong>Admin Logos</strong></a>
                                    <ul>
                                        <li><a href="<?php echo base_url(); ?>admin/admin_logos"><i class="fa fa-caret-right"></i>Admin Logo List</a></li>
                                        <li><a href="<?php echo base_url(); ?>admin/admin_logos?target=add"><i class="fa fa-caret-right"></i>Add Logo</a></li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/admins">
                                        <span><i class="fa fa-folder-open"></i></span><strong>Admins</strong>
                                    </a>
                                    <ul>
                                        <li>
                                            <a href="<?php echo base_url(); ?>admin/admins">
                                                <i class="fa fa-caret-right"></i>Active Admins
                                            </a>
                                        </li>
                                        
                                        <li>
                                            <a href="<?php echo base_url(); ?>admin/admins/add_admins">
                                                <i class="fa fa-caret-right"></i>Add Admins
                                            </a>
                                        </li>
                                    </ul>      
                                </li>
