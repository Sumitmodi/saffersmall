...
require_once VIEWDIR . DS. 'admin' . DS . 'includes' . DS . 'head.php';
require_once VIEWDIR . DS. 'admin' . DS . 'includes' . DS . 'header.php';
require_once VIEWDIR . DS. 'admin' . DS . 'common' . DS . 'functions.php';
?>
