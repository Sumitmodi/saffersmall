                ...
                <tbody>
                    <tr>
                  	...
                  	<?php if($data['status'] == 'A') {?>
                        <td>
                            <a href="<?php echo base_url();?>admin/sfi_control/?target=active&action=inactive_user&id=<?php echo $data['sno'];?>" class="btn btn-xs btn-danger">Inactive</a>
                            <a href="<?php echo base_url();?>admin/sfi_control/?target=active&action=block_user&id=<?php echo $data['sno'];?>" class="btn btn-xs btn-danger">Block</a>
                        </td>
                            <?php } 
                            else {
                            ?>
                        ...
                        <td>
                            <a class="btn btn-xs btn-success" href="<?php echo base_url();?>admin/sfi_control/?target=active&action=active_user&id=<?php echo $data['sno'];?>">Approve</a>
                            <a href="<?php echo base_url();?>admin/sfi_control/?target=active&action=block_user&id=<?php echo $data['sno'];?>" class="btn btn-xs btn-danger">Block</a>
                        </td>
                            <?php }?>
