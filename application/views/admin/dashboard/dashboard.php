                        ...
                        <div class="row">
                                ...
                                <div class="ad-img">
                                    ...
                                    <?php
                                        if (!empty($data['post_man'])){
                                            ...
                                            {
                                                $post_name = @$business['username'];
                                            }
                                        }
                                            $name = str_replace(' ', '-', strtolower($data['item']['name']));
                                        ?>
                                    <a href="<?php echo base_url().'ad/'.$post_name.'/'.$name; ?>">
                            ...
                            <div class="col-lg-9 col-md-9">
                                ...
                                if ($data['item']['status'] == 'W')
                                {
                                    ...
                                    <a href="#" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal<?php echo $k;?>">Disapprove</a>
                                    <?php
                                }
