...
<script type="text/javascript">
    ...
    function favourite(){
        ...
        var formdata = false, username, name;
        if(window.FormData){
        ...
        $.ajax({
        url: "<?php echo base_url()?>ad/favourite",
        type: "POST",
        data: formdata,
        processData: false,
        contentType: false,
...
<section class="detail-section2">
    <div class="inner-banner" style="padding-left: 30px; color: green" id="msg"><?php if(isset($msg)) echo $msg; ?> </div>
                ...
                <div class="social-blog orange">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <div class="save"><a><i class="fa fa-star" onclick="favourite()"></i></a></div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="row">
                            ...
                            <div class="category-list">
                                ...
                                <div class="category clearfix">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 right">
                                            <p><?php echo!empty($liked_by) ? intval($liked_by) : 'Be the first to like'; ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="category clearfix">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="social-icon">
                                        <ul>
                                            <?php 
                                            if($invitation_gateway_links != false){
                                            foreach($invitation_gateway_links as $invitation_gateway_link){?>
                                            <li> <a href="http://<?php echo $invitation_gateway_link['link']?>" target="_blank"><?php echo $invitation_gateway_link['link']; ?></a> </li>
                                            <?php }}?>
                        ...
                        <div class="image clearfix">
                            ...
                            foreach ($extra_result as $rel)
                            {
                                ...
                                $name = strpos($now->name, '-');
                                
                                if($name == TRUE){
                                    $name = str_replace('-', '+', $now->name); 
                                }
                                ...
                                <div class="box-wrapp">
                                    <div class="box"> 
                                        <img src="<?php echo $image; ?>" alt="<?php echo $now->name; ?>" title="<?php echo $name; ?>">
                                        ...
                                        <div class="overlay">
                                            <div class="detail">
                                                <a href="<?php echo base_url() . 'ad/' . $user->username . '/' . str_replace(' ', '-', strtolower($name)); ?>">
                                    ...
                                    <p>
                                                <a href="<?php echo base_url() . 'ad/' . $user->username . '/' . str_replace(' ', '-', strtolower($name)); ?>"><?php echo ucwords($now->name); ?></a></p>
                                    <div class="person">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="box-wrapper">
                    ...
                    <div class="tag-wrap clearfix">
                        ...
                        if (empty($image))
                        {
                            $image = base_url() . 'assets/img/saffersmall-logo-small.png';
                        } else
                        {
                        ...
                        ?>
                        <div class="img-outer">
                            <img src="<?php echo $image; ?>" alt="" style="height: 100px;">
                        </div>
                        <div class="details">
