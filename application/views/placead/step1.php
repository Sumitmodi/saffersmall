...
<section class="place-ads">
    ...
    <?php if (isset($flag)) $action = "?target=ads&action=modify&id=$id&step=2";
    else $action = '?_=2'; ?>
    <form class="form-horizontal" action="<?php echo $action; ?>" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-sm-9">
                <input type="text" class="form-control" name="name" placeholder="Product Name" required="required" value="<?php if (isset($ads->name)) echo $ads->name ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-lg-4 col-md-4 col-sm-9">
                <select class="form-control" required="required" name="category">
                   <?php if(isset($ad_cat->category_name)){
                    ?>
                        <option value="<?php echo strtolower($ad_cat->category_name); ?>" selected=""><?php echo strtoupper($ad_cat->category_name); ?></option>
                    <?php } ?>
        ...
        <div class="form-group">
            <label class="col-lg-3 col-md-3 col-sm-3 control-label"> Ad Type <span>*</span> </label>
            <div class="col-lg-9 col-md-9 col-sm-9 col-sm-9">
                
                <input type="radio" class="" name="ad_type" value="normal_ad"  checked="" > Normal Ad
                
                <input type="radio" class="" name="ad_type" value="link_ad" <?php if (isset($ads->is_link_ad) && $ads->is_link_ad == 1) { ?> checked="" <?php } ?>> Link Ad
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4 col-md-4 col-sm-9">
                <input type="text" class="form-control" name="price" placeholder="$00" required="required" value="<?php if (isset($ads->price)) echo $ads->price ?>">
            </div>
        </div>
        <?php if ($this->session->userdata('is_sfi') == 1) { ?>
            <div class="form-group">
                ...
                <div class="col-lg-4 col-md-4 col-sm-9">
                    <input type="text" class="form-control" name="website" placeholder="Your SFI product link" value="<?php if (isset($ads->profile_link)) echo $ads->profile_link ?>">
                </div>
            </div>
        <?php } ?>
        <div class="form-group">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9">
                <textarea rows="5" name="description" class="form-control ckeditor" placeholder="Enter detailed description of your product"><?php if (isset($ads->description)) echo $ads->description ?></textarea>
            </div>
        </div>
        <div class="row">
