...
<section class="place-ads">
    ...
    <?php if(isset($flag)) $action = "?target=ads&action=modify&id=$id&step=3"; else $action = '?_=3'; ?>
    <form class="form-horizontal" action="<?php echo $action;?>" method="post">
        <label class="col-lg-12 col-md-12 col-sm-12 control-label" style="text-align: left;">
            <small> Set your targeted location. You get to choose where you want your ad to be displayed. Your ad will be placed in that particular location only. This helps you target very specific customers which is good for your business.</small>
        </label>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9">
                <select class="form-control" name="country">
                    <?php if(isset($ads->country)){ ?>
                    <option value="<?php echo $ads->country?>" selected="selected"><?php echo $ads->country?></option>
                    <?php } ?>
                    ...
                    <option value="Palestinian Territory">Panama</option>
                    ...
                    <option value="Timor-Leste">Togo</option>
        ...
        <div class="form-group">
            <label class="col-lg-3 col-md-3 col-sm-3  control-label"> State </label>
            <div class="col-lg-9 col-md-9 col-sm-9">
                <input type="text" class="form-control" placeholder="State" name="state" value="<?php if(isset($ads->location)) echo $ads->location?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-3 col-md-3 col-sm-3  control-label"> City  </label>
            <div class="col-lg-9 col-md-9 col-sm-9">
                <input type="text" class="form-control" placeholder="City" name="city" value="<?php if(isset($ads->city)) echo $ads->city?>">
            </div>
        </div>
        <div class="form-group">
