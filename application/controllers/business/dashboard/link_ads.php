...
class Link_ads extends CI_Controller
{
    ...
    public function enter()
    {
        try
        {
            ...
            $this->data['title'] = $this->title('Link Ads', 'Dashboard');
            ...
            $ads = $this->model->select('business_ads', '*', array('bid' => $user->sno, 'is_link_ad'=>1), array('date_added' => 'desc'));
