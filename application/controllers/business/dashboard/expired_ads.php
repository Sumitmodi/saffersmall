...
class Expired_ads extends CI_Controller
{
    ...
    public function enter()
    {
        try
        {
            ...
            $this->data['title'] = $this->title('Expired Ads', 'Dashboard');
            ...
            $ads = $this->model->select('business_ads', '*', array('bid' => $user->sno, 'LOWER(status)'=>'e'), array('date_added' => 'desc'));
