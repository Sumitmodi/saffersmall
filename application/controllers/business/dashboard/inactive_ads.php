...
class Inactive_ads extends CI_Controller
{
    ...
    public function enter()
    {
        try
        {
            ...
            $this->data['title'] = $this->title('Inactive Ads', 'Dashboard');
            ...
            $ads = $this->model->select('business_ads', '*', array('bid' => $user->sno, 'LOWER(status)'=>'i'), array('date_added' => 'desc'));
