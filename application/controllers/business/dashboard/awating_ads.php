...
class Awating_ads extends CI_Controller
{
    ...
    public function enter()
    {
        try
        {
            ...
            $this->data['title'] = $this->title('Awating Ads', 'Dashboard');
            ...
            $ads = $this->model->select('business_ads', '*', array('bid' => $user->sno, 'LOWER(status)'=>'w'), array('date_added' => 'desc'));
