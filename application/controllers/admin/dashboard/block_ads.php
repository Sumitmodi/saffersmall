...
class Block_ads extends CI_Controller
{
    ...
    public function block_ads()
    {
        try
        {
            /*
             * Load all the disapproved ads.
             */
            $ads = $this->model1->select('business_ads', '*', array('LOWER(status)' => 'd'));
            ...
            $this->data['title'] = $this->title('Ads ', 'blocked');
            ...
            $this->message = $ads == false ? 'No disaprroved ads currently' : count($ads) . ' ads are blocked.';
