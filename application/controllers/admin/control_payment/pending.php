...
class Pending extends CI_Controller
{
    ...
    public function pending()
    {
        try
        {
            $tra = $this->model1->select('transaction_info', '*', array('payment_status' => 'P'), array('pay_time' => 'asc'));
            ...
            $this->data['title'] = $this->title('Payments ', 'Pending');
            
            $this->page = 'admin/control_payment/control_payment';
            
            $this->header = 200;
            
            $this->message = 'Pending payments dashboard.';
